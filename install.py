...
rDownloadURL = {"main": "https://www.dropbox.com/s/owk71o54oo6cnhu/main.tar.gz?dl=1", "sub": "https://www.dropbox.com/s/hb5brhnvm9jbt90/sub.tar.gz?dl=1"}
    ...
    if rType.upper() in ["MAIN", "LB"]:
        ...
        if len(rHost) > 0 and len(rPassword) > 0 and rServerID > -1:
            ...
            if raw_input("  ").upper() == "Y":
                ...
                printc("Admin UI: http://%s:8080" % getIP())
                if rType.upper() == "MAIN":
